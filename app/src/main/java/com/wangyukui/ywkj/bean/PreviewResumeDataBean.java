...
public class PreviewResumeDataBean implements Serializable {
    ...
    public static class DataBean {
         ...
         * resume_cer : [{"id":102,"certificate_name":"C语言","gettime":"2015-01-01","gettime_name":"2015年"},{"id":101,"certificate_name":"java二级证书","gettime":"2014-01-01","gettime_name":"2014年"}]
         * resume_lang : [{"id":120,"language":3,"degree":2,"level":34,"language_name":"英语","level_name":"CET6"}]
         * resume_other : [{"id":109,"title":"宗教信仰","content":"我呢恶魔也饿"},{"id":108,"title":"职业目标","content":"我饿的咯唾沫哦哦无尽空虚5门XX门哦哟我的看见了咯YY默默我OK吉拉魔图咯的哦下雨了哦哦哦控制"}]
         */
