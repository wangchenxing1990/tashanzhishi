...
import com.wangyukui.ywkj.activity.AddressActivity;
...
public class CompanyBriefFragment extends Fragment implements View.OnClickListener {
    ...
    private void initdata() {
        ...
        Log.i("com_idcom_idcom_id", com_id);
        OkhttpUtils.getInstance().sendPostHttp(ContentUrl.BASE_URL + ContentUrl.COMPANY_BASIC_SHOW, api_token, formEncodingBuilder, new Callback() {
            @Override
