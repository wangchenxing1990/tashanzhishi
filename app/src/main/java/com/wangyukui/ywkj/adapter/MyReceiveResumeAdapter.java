...
public class MyReceiveResumeAdapter extends BaseRecyclerAdapter<MyReceiveResumeAdapter.MyViewHolder>implements View.OnClickListener  {
    ...
    private List<FindWorkDataBean.DataBean> list;
    private Context context;

    public MyReceiveResumeAdapter(List<FindWorkDataBean.DataBean> list, Context context) {
        this.list = list;
        this.context = context;
    }


    public void setData(List<FindWorkDataBean.DataBean> data,boolean fresh){
        if(fresh){
            list.clear();
        }
        list.addAll(data);
    ...
    public void onClick(View v) {
        if (mOnItemClickListener!=null){
            mOnItemClickListener.onItemClick(v, (FindWorkDataBean.DataBean) v.getTag());
        }
    }
    ...
    public static interface OnRecyclerViewOnItemClickListener{
        void onItemClick(View v,FindWorkDataBean.DataBean data);
    }
