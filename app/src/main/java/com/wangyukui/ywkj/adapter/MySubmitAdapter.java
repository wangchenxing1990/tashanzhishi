...
public class MySubmitAdapter extends BaseRecyclerAdapter<MySubmitAdapter.MyViewHolder> {
    private List<SubmitResumeDataBean.DataBean> lists;
    private Context context;
    private String api_token;
    private String str;
    private int code;
    public MySubmitAdapter(List<SubmitResumeDataBean.DataBean> list, Context context) {
        this.lists = list;
    ...
    public void setData(List<SubmitResumeDataBean.DataBean> data,boolean fresh) {
    ...
    public void onBindViewHolder(MySubmitAdapter.MyViewHolder holder, final int position, boolean isItem) {
        String statue = lists.get(position).getStatus()+"";
        holder.textcompanyname.setText(lists.get(position).getCompany_name());
        holder.textjobname.setText(lists.get(position).getJob_title());
        holder.textcreatetime.setText(lists.get(position).getCreated_at());
        ...
        holder.mian_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id", lists.get(position).getJob_id());
...
//        myPopuwindown.showAtLocation(SubmitResumeActivity.this.findViewById(R.id.ll_popuwind), Gravity.CENTER, 0, 0);
        ...
        foem.add("id", String.valueOf(lists.get(position).getId()));
        foem.add("status", "4");
