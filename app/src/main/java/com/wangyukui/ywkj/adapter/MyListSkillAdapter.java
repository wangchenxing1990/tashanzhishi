...
public class MyListSkillAdapter extends DefualtAdapter {
    private List<EditResumeDataBean.DataBean.ResumeSkillBean> datas;
    public MyListSkillAdapter(List<EditResumeDataBean.DataBean.ResumeSkillBean> datas) {
        super(datas);
        this.datas=datas;
    }

    public void setData(List<EditResumeDataBean.DataBean.ResumeSkillBean>  data){
        datas.clear();
        datas.addAll(data);
