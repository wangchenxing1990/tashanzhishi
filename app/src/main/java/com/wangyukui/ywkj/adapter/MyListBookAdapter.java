...
public class MyListBookAdapter extends DefualtAdapter {
    private List<EditResumeDataBean.DataBean.ResumeCerBean> datas;
    public MyListBookAdapter(List<EditResumeDataBean.DataBean.ResumeCerBean> datas) {
        super(datas);
        this.datas=datas;
    }

    public void setData(List<EditResumeDataBean.DataBean.ResumeCerBean> data){
        datas.clear();
        datas.addAll(data);
