...
public class EditSearchEnginedActivity extends BaseActiviyt implements View.OnClickListener {
    ...
    public void initData() {
        ...
        formEncod.add("id", id);
        OkhttpUtils.getInstance().sendPostHttp(ContentUrl.BASE_URL + ContentUrl.SEARCH_ENGINE_EDIT, api_token, formEncod, new Callback() {
            @Override
...
//        Log.i("jobsortIdjobsortIdjobsortId", jobsortId);
        ...
        OkhttpUtils.getInstance().sendPostHttp(ContentUrl.BASE_URL + ContentUrl.SEARCH_ENGINE_UPDATE, api_token, formEncoding, new Callback() {
            @Override
            public void onFailure(Request request, IOException e) {
    ...
    private void deteleSearcher() {
        ...
        form.add("id", id);
        OkhttpUtils.getInstance().sendPostHttp(ContentUrl.BASE_URL + ContentUrl.SEARCH_ENGINE_DELETE, api_token, form, new Callback() {
            @Override
            public void onFailure(Request request, IOException e) {
